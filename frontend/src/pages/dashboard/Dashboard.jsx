...
const Dashboard = () => {
    ...
    const Fetchuserdata = async () => {
      try {
        ...
        if (response.ok) {
          ...
          /*const totalOrders = datares.totalOrders;
              console.log(totalOrders)
              const totalSales = datares.totalSales;
              const trendingBooks = datares.trendingBooks;
              const totalBooks = datares.totalBooks;
              const monthlySales = datares.monthlySales;
  ...
  return (
    <>
      <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6 pb-6">
      ...
      <section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
        ...
        <div className="row-span-3 bg-white shadow rounded-lg">
          ...
          <div className="overflow-y-auto max-h-384">
